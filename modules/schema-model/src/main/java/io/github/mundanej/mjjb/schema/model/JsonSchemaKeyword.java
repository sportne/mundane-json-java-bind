...
public enum JsonSchemaKeyword {
  ...
  REF("$ref", JsonSchemaKeywordSupport.UNSUPPORTED),
  DYNAMIC_REF("$dynamicRef", JsonSchemaKeywordSupport.UNSUPPORTED),
  DEFS("$defs", JsonSchemaKeywordSupport.UNSUPPORTED),
  ...
  MULTIPLE_OF("multipleOf", JsonSchemaKeywordSupport.UNSUPPORTED),
  UNIQUE_ITEMS("uniqueItems", JsonSchemaKeywordSupport.UNSUPPORTED),
  ...
  MAX_PROPERTIES("maxProperties", JsonSchemaKeywordSupport.UNSUPPORTED),
  MIN_PROPERTIES("minProperties", JsonSchemaKeywordSupport.UNSUPPORTED),
  DEPENDENT_REQUIRED("dependentRequired", JsonSchemaKeywordSupport.UNSUPPORTED),
